...
def get_day_details(user_id, day_iso):
    ...
    try:
        module = _import("web.app.services.training.load_service")
    ...
    try:
        module = _import("web.app.services.nutrition.stats_service")
    ...
    try:
        module = _import("web.app.services.recovery.snapshot_service")
