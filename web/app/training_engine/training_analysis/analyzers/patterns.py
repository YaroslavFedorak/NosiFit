...
from web.app.training_engine.training_analysis.analyzers.utils import movement_pattern
from web.app.training_engine.training_analysis.constants import (
    PATTERN_HIGH_THRESHOLD,
    PATTERN_LOW_THRESHOLD,
)
from web.app.training_engine.training_analysis.dto import PatternResult
