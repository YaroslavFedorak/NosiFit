...
from web.app.training_engine.training_analysis.analyzers.muscles import (
    analyse_muscles,
)

from web.app.training_engine.training_analysis.analyzers.patterns import (
    analyse_patterns,
)

from web.app.training_engine.training_analysis.analyzers.progression import (
    analyse_progression,
)

from web.app.training_engine.training_analysis.analyzers.load import (
    analyse_load,
)

from web.app.training_engine.training_analysis.analyzers.recovery import (
    analyse_recovery,
)

from web.app.training_engine.training_analysis.analyzers.diversity import (
    analyse_diversity,
)

from web.app.training_engine.training_analysis.analyzers.frequency import (
    analyse_frequency,
)

from web.app.training_engine.training_analysis.analyzers.utils import (
    pattern_key,
    primary_muscles,
    movement_pattern,
)
