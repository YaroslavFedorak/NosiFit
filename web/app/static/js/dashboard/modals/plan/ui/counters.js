...
function createLabel(label, icon) {
    ...
    const labelElement = row.querySelector(".db-plan-field-label");
    if (labelElement) {
...
export function createNumberField(label, icon, value, onChange) {
    ...
    arrows.className =
        "db-input-arrows";
    arrows.append(createArrow("db-arrow db-arrow-up", () => update(Number(input.value) + 1)), createArrow("db-arrow db-arrow-down", () => update(Number(input.value) - 1)));
...
export function createRepsField(value, onChange) {
    ...
    arrows.className =
        "db-input-arrows";
    arrows.append(createArrow("db-arrow db-arrow-up", () => {
