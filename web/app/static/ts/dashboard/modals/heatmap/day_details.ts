...
"dashboard-day-details-modal",
);

const content =
    document.getElementById(
        "dashboard-day-details-content",
    );

const date =
    document.getElementById(
        "dashboard-day-details-date",
    );
...
document.addEventListener(
    ...
    (
        ...
        const customEvent =
            event as CustomEvent<HeatmapDay>;
