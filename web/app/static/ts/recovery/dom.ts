...
export function createLoading(text: string): HTMLDivElement {
...
export function createError(text: string): HTMLDivElement {
    const div = document.createElement("div");
    div.className = "error";
    div.textContent = text;
    return div;
...
export function createEmpty(text: string): HTMLDivElement {
    const div = document.createElement("div");
    div.className = "empty";
    div.textContent = text;
    return div;
