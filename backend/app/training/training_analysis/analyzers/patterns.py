...
from backend.app.training.training_analysis.analyzers.utils import movement_pattern
from backend.app.training.training_analysis.constants import (
    PATTERN_HIGH_THRESHOLD,
    PATTERN_LOW_THRESHOLD,
)
from backend.app.training.training_analysis.dto import PatternResult
