...
from backend.app.training.training_analysis.analyzers.muscles import (
    analyse_muscles,
)

from backend.app.training.training_analysis.analyzers.patterns import (
    analyse_patterns,
)

from backend.app.training.training_analysis.analyzers.progression import (
    analyse_progression,
)

from backend.app.training.training_analysis.analyzers.load import (
    analyse_load,
)

from backend.app.training.training_analysis.analyzers.recovery import (
    analyse_recovery,
)

from backend.app.training.training_analysis.analyzers.diversity import (
    analyse_diversity,
)

from backend.app.training.training_analysis.analyzers.frequency import (
    analyse_frequency,
)

from backend.app.training.training_analysis.analyzers.utils import (
    pattern_key,
    primary_muscles,
    movement_pattern,
)

from backend.app.training.training_analysis.constants import (
    WEAK_MUSCLE_SCORE,
    OVERLOAD_PENALTY,
    PATTERN_SCORE,
